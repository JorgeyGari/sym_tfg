...
\begin{itemize}
  ...
  \item The implementation of the program is detailed in \chapterref{appendix-a}, which includes algorithms, helper functions and custom definitions for the behavior of the data structures.
\end{itemize}
